...
class ArrayInitializer(graph_4762: odb2.Graph, seq_4762: Int) extends StoredNode(graph_4762, 4.toShort , seq_4762) with Expression with AstNode {
def argumentIndex: Int = odb2.Accessors.getNodePropertySingle[Int](graph, nodeKind, 3, seq)
def argumentName: Option[String] = odb2.Accessors.getNodePropertyOption[String](graph, nodeKind, 4, seq)
def code: String = odb2.Accessors.getNodePropertySingle[String](graph, nodeKind, 15, seq)
def columnNumber: Option[Int] = odb2.Accessors.getNodePropertyOption[Int](graph, nodeKind, 16, seq)
...
class Identifier(graph_4762: odb2.Graph, seq_4762: Int) extends StoredNode(graph_4762, 23.toShort , seq_4762) with LocalLike with Expression {
def argumentIndex: Int = odb2.Accessors.getNodePropertySingle[Int](graph, nodeKind, 3, seq)
def argumentName: Option[String] = odb2.Accessors.getNodePropertyOption[String](graph, nodeKind, 4, seq)
def code: String = odb2.Accessors.getNodePropertySingle[String](graph, nodeKind, 15, seq)
def columnNumber: Option[Int] = odb2.Accessors.getNodePropertyOption[Int](graph, nodeKind, 16, seq)
...
class ImplicitCall(graph_4762: odb2.Graph, seq_4762: Int) extends StoredNode(graph_4762, 24.toShort , seq_4762) with TrackingPoint with CallRepr {
def code: String = odb2.Accessors.getNodePropertySingle[String](graph, nodeKind, 15, seq)
def columnNumber: Option[Int] = odb2.Accessors.getNodePropertyOption[Int](graph, nodeKind, 16, seq)
def depthFirstOrder: Int = odb2.Accessors.getNodePropertySingle[Int](graph, nodeKind, 23, seq)
def internalFlags: Int = odb2.Accessors.getNodePropertySingle[Int](graph, nodeKind, 41, seq)
...
class Local(graph_4762: odb2.Graph, seq_4762: Int) extends StoredNode(graph_4762, 31.toShort , seq_4762) with LocalLike with Declaration with AstNode {
def closureBindingId: Option[String] = odb2.Accessors.getNodePropertyOption[String](graph, nodeKind, 13, seq)
def code: String = odb2.Accessors.getNodePropertySingle[String](graph, nodeKind, 15, seq)
def columnNumber: Option[Int] = odb2.Accessors.getNodePropertyOption[Int](graph, nodeKind, 16, seq)
def dynamicTypeHintFullName: IndexedSeq[String] = odb2.Accessors.getNodePropertyMulti[String](graph, nodeKind, 27, seq)
...
class Method(graph_4762: odb2.Graph, seq_4762: Int) extends StoredNode(graph_4762, 36.toShort , seq_4762) with CfgNode with Declaration with AstNode {
...
class MethodParameterIn(graph_4762: odb2.Graph, seq_4762: Int) extends StoredNode(graph_4762, 38.toShort , seq_4762) with LocalLike with CfgNode with Declaration with TrackingPoint with AstNode {
def code: String = odb2.Accessors.getNodePropertySingle[String](graph, nodeKind, 15, seq)
def columnNumber: Option[Int] = odb2.Accessors.getNodePropertyOption[Int](graph, nodeKind, 16, seq)
def depthFirstOrder: Int = odb2.Accessors.getNodePropertySingle[Int](graph, nodeKind, 23, seq)
def dynamicTypeHintFullName: IndexedSeq[String] = odb2.Accessors.getNodePropertyMulti[String](graph, nodeKind, 27, seq)
...
class MethodParameterOut(graph_4762: odb2.Graph, seq_4762: Int) extends StoredNode(graph_4762, 39.toShort , seq_4762) with CfgNode with Declaration with TrackingPoint with AstNode {
def code: String = odb2.Accessors.getNodePropertySingle[String](graph, nodeKind, 15, seq)
def columnNumber: Option[Int] = odb2.Accessors.getNodePropertyOption[Int](graph, nodeKind, 16, seq)
def depthFirstOrder: Int = odb2.Accessors.getNodePropertySingle[Int](graph, nodeKind, 23, seq)
def evaluationStrategy: String = odb2.Accessors.getNodePropertySingle[String](graph, nodeKind, 28, seq)
...
class MethodReturn(graph_4762: odb2.Graph, seq_4762: Int) extends StoredNode(graph_4762, 41.toShort , seq_4762) with CfgNode with TrackingPoint {
def code: String = odb2.Accessors.getNodePropertySingle[String](graph, nodeKind, 15, seq)
def columnNumber: Option[Int] = odb2.Accessors.getNodePropertyOption[Int](graph, nodeKind, 16, seq)
def depthFirstOrder: Int = odb2.Accessors.getNodePropertySingle[Int](graph, nodeKind, 23, seq)
def dynamicTypeHintFullName: IndexedSeq[String] = odb2.Accessors.getNodePropertyMulti[String](graph, nodeKind, 27, seq)
...
def annotationParameters: IndexedSeq[SpAnnotationParameter] = odb2.Accessors.getNodePropertyMulti[SpAnnotationParameter](graph, nodeKind, 87, seq)
def method: Method = odb2.Accessors.getNodePropertySingle[Method](graph, nodeKind, 85, seq)
...
class PostExecutionCall(graph_4762: odb2.Graph, seq_4762: Int) extends StoredNode(graph_4762, 47.toShort , seq_4762) with TrackingPoint with CallRepr {
def code: String = odb2.Accessors.getNodePropertySingle[String](graph, nodeKind, 15, seq)
def columnNumber: Option[Int] = odb2.Accessors.getNodePropertyOption[Int](graph, nodeKind, 16, seq)
def depthFirstOrder: Int = odb2.Accessors.getNodePropertySingle[Int](graph, nodeKind, 23, seq)
def internalFlags: Int = odb2.Accessors.getNodePropertySingle[Int](graph, nodeKind, 41, seq)
