...
a type alias of. */
public static final int ALIAS_TYPE_FULL_NAME = "0";
...
this field is unset. */
public static final int ARGUMENT_NAME = "2";

/** This field holds the FULL_NAME of the AST parent of an entity. */
public static final int AST_PARENT_FULL_NAME = "3";
...
public static final int AST_PARENT_TYPE = "4";
...
public static final int CANONICAL_NAME = "5";


public static final int CLASS_NAME = "6";


public static final int CLASS_SHORT_NAME = "7";
...
public static final int CLOSURE_BINDING_ID = "8";

/** The original name of the (potentially mangled) captured variable */
public static final int CLOSURE_ORIGINAL_NAME = "9";
...
public static final int COLUMN_NUMBER_END = "12";
...
public static final int CONTAINED_REF = "13";
...
public static final int CONTROL_STRUCTURE_TYPE = "15";

/** The group ID for a dependency */
public static final int DEPENDENCY_GROUP_ID = "16";
...
public static final int DISPATCH_TYPE = "17";

/** Type hint for the dynamic type. These are observed to be verifiable at runtime. */
public static final int DYNAMIC_TYPE_HINT_FULL_NAME = "18";
...
public static final int EVALUATION_STRATEGY = "19";
...
public static final int EXPLICIT_AS = "20";
...
public static final int IMPORTED_AS = "24";
...
public static final int IMPORTED_ENTITY = "25";
...
public static final int INHERITS_FROM_TYPE_FULL_NAME = "27";
...
code base. */
public static final int IS_EXPLICIT = "28";
...
public static final int IS_EXTERNAL = "29";
...
public static final int IS_VARIADIC = "30";
...
public static final int IS_WILDCARD = "31";
...
represented by the node ends. */
public static final int LINE_NUMBER_END = "35";
...
public static final int METHOD_FULL_NAME = "36";


public static final int METHOD_SHORT_NAME = "37";
...
public static final int MODIFIER_TYPE = "38";

/** Name of represented object, e.g., method name (e.g. "run") */
public static final int NAME = "39";


public static final int NODE_LABEL = "40";
...
public static final int PACKAGE_NAME = "43";

/** AST node type name emitted by parser. */
public static final int PARSER_TYPE_NAME = "44";
...
public static final int POSSIBLE_TYPES = "45";
...
public static final int SIGNATURE = "47";
...
public static final int TYPE_DECL_FULL_NAME = "49";
...
public static final int TYPE_FULL_NAME = "50";
